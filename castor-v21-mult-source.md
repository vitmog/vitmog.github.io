...
plots:
  - path: "/plots/castor-v21/single-mult-src/g_3_vtn1.gif"
  - path: "/plots/castor-v21/single-mult-src/g_3_vtn4.gif"
  - path: "/plots/castor-v21/single-mult-src/g_3_err_vtn1.gif"
    label: "(a) 18 source energy groups"
  - path: "/plots/castor-v21/single-mult-src/g_3_err_vtn4.gif"
...
{% include plot_grid.html
   plots=page.plots
   cols=2
   caption="Figure: Gamma axial <strong>dose per source particle</strong> and relative error distributions for the single cask."
%}

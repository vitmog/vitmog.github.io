# Protvino Concrete Labyrinth Benchmark (ALARAM-CF-AIR-LAB-001)
...
The goal is computation of spatial distribution of a neutron flux linear fuctional which relates to the Bonner sphere detector count rates.
Those are considered Case 5A (2 polyethylene plates in 2nd section) and Case 6B (covered source and dead-end).

Computable flux functional - pulse rate by the detector response function is taken from the benchmark data for the case of 5 in. Bonner polyethylene sphere diameter.

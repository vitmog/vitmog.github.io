...
description: "Dose rate plots obtained by variance reduction for Monte Carlo particle transport for a spent fuel cask including skyshine problems."
...
g_plot:
  - path: "/plots/castor-v21/single/g_4_spec.png"
    alt: "Side cask primary gamma dose rate"
  - path: "/plots/castor-v21/single/g_4_spec_err.png"
    alt: "Side cask primary gamma relative error"
---

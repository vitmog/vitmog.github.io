...
As a result, the achieved numerical performance provided the ability to obtain detailed smooth and valid numerous dose rate mappings in the screen resolution (typically, 1000 on 1000 bins) for full-scale calculations on a workstation based on 4-6 **Intel Core i7-2700K CPU @ 3.50GHz** in around 1-2 days since 2015-2016. However, for final safety report releases and publications, such as the one performed here, I had often been running longer calculations in 1 week.

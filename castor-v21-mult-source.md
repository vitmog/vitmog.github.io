...
description: "Dose rate plot animation for several source spectra shielding cases in a single Monte Carlo run."
...
plots:
  - path: "/plots/castor-v21/single-mult-src/g_3_vtn1.apng"
    alt: "18 source energy group dose rate"
  - path: "/plots/castor-v21/single-mult-src/g_3_vtn4.apng"
    alt: "44 source energy group dose rate"
...
For the given [model](castor-v21.md) of the isolated CASTOR-V/21 cask, six source spectra cases are considered for the gamma type of radiation (see Table).

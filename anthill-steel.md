...
description: "Variance reduction for Monte Carlo particle transport for multiple orders of magnitude attenuation: self-shielded sources, labyrinths, slabs, etc."

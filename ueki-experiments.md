...
plots:
  - path: "/plots/ueki-experiments/n_1.png"
  - path: "/plots/ueki-experiments/g2_1.png"
  - path: "/plots/ueki-experiments/n_1_err.png"
    label: "(a) Neutron"
  - path: "/plots/ueki-experiments/g2_1_err.png"
    label: "(b) Sec. Gamma"
---
...
{% include plot_grid.html
   plots=page.plots
   cols=2
   caption="Figure 2: Dose rate (in μSv/h) and relative error plots."
%}

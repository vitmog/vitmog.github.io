...
[Prev](anthill.md) [**.....**](shielding-evaluations.md)

# Steel Anthill toy model

All of paparemers of the model are the same as in [Concrete Anthill](anthill.md) but steel is used as shielding material instead of concrete one.

...
description: "Neutron and secondary gamma dose rate plot animation for the slab shielding benchmark obtained using the methodology that implements Monte Carlo variance reduction techniques"
...
plots:
  - path: "/plots/ueki-experiments/n_1.apng"
    alt: "Neutron dose rate"
  - path: "/plots/ueki-experiments/g2_1.apng"
    alt: "Secondary gamma dose rate"
...
Thicknesses of volumetric detectors are equal to 2 cm. Results of the six computations, each took approximately 3 hours, are presented in Figure 2 (see details in [3]).

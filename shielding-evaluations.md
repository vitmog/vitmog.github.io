...
In this section, short descriptions of examples of modern Monte Carlo techniques for neutral particle transport applications results are provided. For more information about the used methodology and considered computational cases see [[1](https://doi.org/10.5281/zenodo.16781417)].
...
# References
1. V.G. Mogulian. An approach to radiation shielding evaluations using estimators by expected scoring. 2025. [DOI:10.5281/zenodo.16995892](https://doi.org/10.5281/zenodo.16995892).

...
It allowed providing calculations of full-scale models without using high-performance workstations. You can find details about the BRAND modernization experience [here](brand-hist.md) and in the [[working paper](https://doi.org/10.5281/zenodo.16781417)].

...
plots:
  - path: "/plots/castor-v21/single-mult-thick/n_3.gif"
  - path: "/plots/castor-v21/single-mult-thick/g2_3.gif"
  - path: "/plots/castor-v21/single-mult-thick/g_3.gif"
  - path: "/plots/castor-v21/single-mult-thick/n_3_err.gif"
    label: "(a) Neutron"
  - path: "/plots/castor-v21/single-mult-thick/g2_3_err.gif"
    label: "(b) Sec. Gamma"
  - path: "/plots/castor-v21/single-mult-thick/g_3_err.gif"
    label: "(c) Pr. Gamma"
---
...
{% include plot_grid.html
   plots=page.plots
   cols=3
   caption="Figure: Axial dose rate and relative error plots for the single cask."
%}

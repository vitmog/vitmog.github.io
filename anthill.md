...
Below, some results of neutron-gamma and gamma problems 24.3 hours long computation are presented  (see details in [2]). Despite the smoothness of the plots, valid estimations seems to require $\times 10$ times larger statistics for enough precision.

|[![]({{ site.baseurl }}/plots/anthill/n_1.png)]({{ site.baseurl }}/plots/anthill/n_1.png) |
|:--:|
| Figure 2: Neutron horizontal dose rates distribution |

|[![]({{ site.baseurl }}/plots/anthill/g2_1.png)]({{ site.baseurl }}/plots/anthill/g2_1.png) |
|:--:|
| Figure 3: Secondary gamma horizontal dose rates distribution |

|[![]({{ site.baseurl }}/plots/anthill/g_1.png)]({{ site.baseurl }}/plots/anthill/g_1.png) |
|:--:|

...
{% include plot_grid.html
   ...
   cols=3
   caption="Figure 3: Neutron relative error distributions."
%}
...
{% include plot_grid.html
   ...
   cols=3
   caption="Figure 5: Gamma relative error distributions."
%}

{% include plot_grid.html
   plots=page.g_plot
   cols=2
   caption="Figure 6: Primary gamma side surface dose rates and relative errors for the single cask (the extended calculation for 25.2 hours)."
%}

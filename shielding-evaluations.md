...
description: "Implementation of the shielding evaluation methodology in the BRAND neutron-gamma code and testing on self-shielded source, skyshine, streaming, labyrinths, strong attenuation, multicase problems."
 ...
 * **Skyshine**: dominant contribution of air-scattered radiation;
 * **Tiny holes**: dominant contribution through small heterogeneity (-ies) in an attenuating shield;
 * **Labyrinths**: dominant contribution of multiple scattered on corridors and rooms walls radiation;
 * **Multi-case**: multiple cases in a single calculation.

| Problem name | Thick source | Strong attenuation | Skyshine | Tiny holes | Labyrinths | Multi-case |
| :-- | :--: | :--: | :--: | :--: | :--: | :--: |

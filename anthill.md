...
description: "Variance reduction for Monte Carlo particle transport for 15-20 orders of magnitude attenuation: self-shielded sources, labyrinths, slabs, streamings, etc."
permalink: /anthill/       
sidebar: true             
toc: true
redirect_from:
...
In this calculation, the following techniques are used:
 ...
 - Joint location-direction importance sampling (for gamma only);
 - Energy importance sampling (for gamma only);

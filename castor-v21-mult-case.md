...
For the given [model](castor-v21.md) of the isolated CASTOR-V/21 cask, those are considered additional 5 cases for each type of radiation defined using the cutting cask side wall shield by cylindrical surfaces. These 5 cases in total have been completed in a single computation of total running time - 12.1 hours.

Computed flux functional - ambient equivalent dose H*(10) [1] rates.

Below, results of neutron-gamma and gamma problems computations are performed (see details in [2]).
...
2. V.G. Mogulian. An approach to radiation shielding evaluations using estimators by expected scoring. 2025. [doi:10.5281/zenodo.16995892](https://doi.org/10.5281/zenodo.16995892).

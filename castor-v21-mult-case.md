...
Using the given in [section](castor-v21.md) conditions for the single cask, those are additionally considered 4 cases for each type of radiation of the cask side wall shield cut by cylindrical surfaces. These 5 cases in total have been completed in a single computation of total running time - 12.1 hours.

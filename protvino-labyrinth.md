...
|[![]({{ site.baseurl }}/plots/labyrinth-protvino/xy-5A.png)]({{ site.baseurl }}/plots/labyrinth-protvino/xy-5A.png) |
|:--:|
| Figure 1: Horizontal cross-section of Case 5A model |

|[![]({{ site.baseurl }}/plots/labyrinth-protvino/xy-6B.png)]({{ site.baseurl }}/plots/labyrinth-protvino/xy-6B.png) |
|:--:|
| Figure 2: Horizontal cross-section of Case 6B model |

Thicknesses of volumetric detectors are equal to 10 cm.
Results of the two 11.2 hours long concurrently ran computations are presented in Figures 3-5 (see details in [2]).

|[![]({{ site.baseurl }}/plots/labyrinth-protvino/case5A.png)]({{ site.baseurl }}/plots/labyrinth-protvino/case5A.png) |
|:--:|
...
|[![]({{ site.baseurl }}/plots/labyrinth-protvino/case6B.png)]({{ site.baseurl }}/plots/labyrinth-protvino/case6B.png) |
|:--:|

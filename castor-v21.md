...
Below, the results of the neutron-gamma and gamma problems computations are presented (see details in [3]).

## Neutron results

|[![]({{ site.baseurl }}/plots/castor-v21/single/n_1.png)]({{ site.baseurl }}/plots/castor-v21/single/n_1.png) |
|:--:|
| Figure 2: Neutron axial dose rates distribution for the single cask (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/n_1.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/n_1.png) |
|:--:|
| Figure 3: Neutron vertical dose rates distribution for the cask in the skyshine model (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/n_2.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/n_2.png) |
|:--:|
| Figure 4: Neutron vertical dose rates distribution for the cask in the skyshine model (100 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-perf-wall/n_2.png)]({{ site.baseurl }}/plots/castor-v21/single-perf-wall/n_2.png) |
|:--:|
| Figure 5: Neutron vertical dose rates for the cask in the skyshine model with the perforation (100 cm thick) |


|[![]({{ site.baseurl }}/plots/castor-v21/single/n_3.png)]({{ site.baseurl }}/plots/castor-v21/single/n_3.png) |
|:--:|
| Figure 6: Neutron azimuthal dose rates for the single cask (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/n_3.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/n_3.png) |
|:--:|
| Figure 7: Neutron horizontal dose rates for the cask in the skyshine model (50 cm thick) |

## Primary gamma results

|[![]({{ site.baseurl }}/plots/castor-v21/single/g_1.png)]({{ site.baseurl }}/plots/castor-v21/single/g_1.png) |
|:--:|
| Figure 8: Primary gamma axial dose rates for the single cask (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/g_1.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/g_1.png) |
|:--:|
| Figure 9: Primary gamma vertical dose rates for the cask in the skyshine model (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/g_2.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/g_2.png) |
|:--:|
| Figure 10: Primary gamma vertical dose rates for the cask in the skyshine model (100 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-perf-wall/g_2.png)]({{ site.baseurl }}/plots/castor-v21/single-perf-wall/g_2.png) |
|:--:|
| Figure 11: Primary gamma vertical dose rates for the cask in the skyshine model with the perforation (100 cm thick) |


|[![]({{ site.baseurl }}/plots/castor-v21/single/g_3.png)]({{ site.baseurl }}/plots/castor-v21/single/g_3.png) |
|:--:|
| Figure 12: Primary gamma azimuthal dose rates for the single cask (20 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single-wall/g_3.png)]({{ site.baseurl }}/plots/castor-v21/single-wall/g_3.png) |
|:--:|
| Figure 13: Primary gamma horizontal dose rates for the cask in the skyshine model (50 cm thick) |

|[![]({{ site.baseurl }}/plots/castor-v21/single/g_4_spec.png)]({{ site.baseurl }}/plots/castor-v21/single/g_4_spec.png) |
|:--:|
